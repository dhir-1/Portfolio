...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Dhir Agrawal — web developer, machine learning enthusiast, and video editor." },
      { name: "author", content: "Dhir Agrawal" },
      { property: "og:title", content: "Dhir Agrawal — Portfolio" },
      { property: "og:description", content: "Selected work in web development, machine learning, and video." },
